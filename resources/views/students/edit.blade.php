            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div>
                        ...
                        កែសម្រួលព័ត៌មានផ្ទាល់ខ្លួន និងទំនាក់ទំនងរបស់សិស្ស
                    </p> --}}
                    </div>
                </div>

                <a href="{{ route('students.index') }}"
                    class="hidden sm:flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-300 bg-white text-sm font-semibold text-gray-700 hover:bg-slate-50 hover:border-slate-400 transition-all duration-200">
        ...
        <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="student_name"
                                        class="block mb-2 text-sm font-semibold text-[color:var(--ink)]">
                                    ...
                                    <div class="relative group">
                                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                ...
                                                class="h-5 w-5 text-gray-400 group-focus-within:text-[color:var(--kh-blue)] transition-colors">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                            </svg>
                                        </div>
                                    ...
                                    @error('student_name')
                                        <p
                                            class="flex items-center gap-1 text-[color:var(--kh-red)] text-xs mt-2 animate-pulse">
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <select id="sex" name="sex" required
                                            class="w-full font-semibold rounded-xl border-2 border-slate-300 bg-white px-10 py-3 text-sm text-[color:var(--ink)] transition-all duration-200 focus:border-[color:var(--kh-blue)] focus:ring-4 focus:ring-[color:var(--kh-blue)]/10 focus:outline-none appearance-none hover:border-slate-400 cursor-pointer">
                                            <option value="">ជ្រើសរើសភេទ</option>
                                            <option value="Male"
                                                {{ old('sex', $student->sex) == 'Male' ? 'selected' : '' }}>ប្រុស</option>
                                            <option value="Female"
                                                {{ old('sex', $student->sex) == 'Female' ? 'selected' : '' }}>ស្រី</option>
                                        </select>
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="date" id="date_of_birth" name="date_of_birth"
                                            ...
                                            required
                                            class="w-full font-semibold rounded-xl border-2 border-slate-300 bg-white px-10 py-3 text-sm text-[color:var(--ink)] transition-all duration-200 focus:border-[color:var(--kh-blue)] focus:ring-4 focus:ring-[color:var(--kh-blue)]/10 focus:outline-none hover:border-slate-400">
                                    </div>
                                    @error('date_of_birth')
                                        <p
                                            class="flex items-center gap-1 text-[color:var(--kh-red)] text-xs mt-2 animate-pulse">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div class="bg-gradient-to-r from-slate-50 to-white px-6 py-4 border-b border-slate-200">
                            <h2 class="text-lg font-bold text-[color:var(--ink)] flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="h-5 w-5 text-[color:var(--kh-blue)]">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <!-- Photo Upload Card -->
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden top-6">
                        <div class="bg-gradient-to-r from-slate-50 to-white px-6 py-4 border-b border-slate-200">
                            <h2 class="text-lg font-bold text-[color:var(--ink)] flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="h-5 w-5 text-[color:var(--kh-blue)]">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-col items-center mb-6">
                                <div class="relative group">
                                    ...
                                    <label for="image"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="h-8 w-8 text-white">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125" />
                                        </svg>
                                    </label>
                                </div>
                                <p class="text-xs text-gray-400 mt-3">ចុចលើរូបភាពដើម្បីផ្លាស់ប្ដូរ</p>
                            </div>
                            ...
                            <!-- File Name Display -->
                            <div id="file-name"
                                class="flex items-center gap-2 text-sm text-[color:var(--kh-blue)] p-3 bg-[color:var(--kh-blue)]/5 rounded-lg hidden animate-fade-in">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="h-4 w-4 flex-shrink-0">
                                    <path fill-rule="evenodd"
                                        d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H4zm5.293 7.293a1 1 0 011.414 0L11 9.586V6a1 1 0 112 0v3.586l.293-.293a1 1 0 111.414 1.414l-2 2a1 1 0 01-1.414 0l-2-2a1 1 0 010-1.414z"
                                        clip-rule="evenodd" />
                                </svg>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div class="p-6 space-y-3">
                            <button type="submit"
                                class="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-[color:var(--kh-blue)] to-[color:var(--kh-blue-deep)] text-sm font-semibold text-white duration-200 focus:ring-4 focus:ring-[color:var(--kh-blue)]/30 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
